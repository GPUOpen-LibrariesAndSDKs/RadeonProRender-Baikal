...
namespace Baikal
{
    ...
    PathTracingEstimator::PathTracingEstimator(
        ...
        Estimator(api)
#ifdef BAIKAL_EMBED_KERNELS
        , ClwClass(context, program_manager, "path_tracing_estimator", g_path_tracing_estimator_opencl, g_path_tracing_estimator_opencl_inc, "")
#else
        ...
        , m_sample_counter(0)
#ifdef BAIKAL_EMBED_KERNELS
        , m_uberv2_kernels(context, program_manager, "path_tracing_estimator_uberv2", g_path_tracing_estimator_uberv2_opencl, g_path_tracing_estimator_uberv2_opencl_inc, "")
#else

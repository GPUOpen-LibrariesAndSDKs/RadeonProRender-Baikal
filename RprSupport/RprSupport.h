...
typedef struct {}*rprx_context;
typedef struct {}*rprx_material;
...
extern "C" {
    ...
    *  @param node              out_result result
    *  @return                  RPR_SUCCESS in case of success, error code otherwise
    */
    extern RPR_API_ENTRY rpr_int rprxIsMaterialRprx(rprx_context context, rpr_material_node node, rpr_bool* out_result);

...
extern RPR_API_ENTRY int rprsxExport(char const * rprsFileName, void * context, void * contextX, void * scene, int extraCustomParam_int_number, char const * * extraCustomParam_int_names, int const * extraCustomParam_int_values, int extraCustomParam_float_number, char const * * extraCustomParam_float_names, float const * extraCustomParam_float_values);
extern RPR_API_ENTRY int rprsxImport(char const * rprsFileName, void * context, void * contextX, void * materialSystem, void * * scene, bool useAlreadyExistingScene);
...
extern RPR_API_ENTRY int frsxExport(char const * frsFileName, void * context, void * contextX, void * scene, int extraCustomParam_int_number, char const * * extraCustomParam_int_names, int const * extraCustomParam_int_values, int extraCustomParam_float_number, char const * * extraCustomParam_float_names, float const * extraCustomParam_float_values);
extern RPR_API_ENTRY int frsxImport(char const * frsFileName, void * context, void * contextX, void * materialSystem, void * * scene, bool useAlreadyExistingScene);
